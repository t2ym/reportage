...
const Config = {
  ...
  _concurrency: typeof navigator === 'object' ? Math.floor(navigator.hardwareConcurrency / 2) : 1,
  get _targetAppHosts() {
  ...
  * originGenerator() {
  ...
  async importedBy(importerURL) {
    ...
    if (typeof location === 'object' &&
        location.origin.startsWith('http://127.0.0.') &&
        Math.random() < 0.2) {
      throw new Error('hang up test');
    }
    */
  ...
  consoleReporter: './test/dump-reporter.js',// 'mochawesome',
