...
let phased_start_timeout = new Suite('start_timeout', 'Description of Phased Start Timeout Suite');
phased_start_timeout.htmlSuite = '/test/mocha.html';
let CommonSuite;
phased_start_timeout.test = CommonSuite = class CommonSuite extends Suite {
  async setup(_this) {
...
phased_start_timeout.test = class Phase0Test extends CommonSuite {
...
phased_start_timeout.test = (base) => class Phase1Test extends base {
...
phased_start_timeout.test = {
  '': [],
  Phase0Test: {
    Phase1Test: 'PhasedStartTimeoutTest',
  },
};
